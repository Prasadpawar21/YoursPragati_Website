...
//   return (
//     <div className="relative bg-gray-100 py-10 px-4 sm:px-6 lg:px-16">
//       <h2 className="text-3xl font-bold text-center text-gray-800 mb-2">Blogs</h2>
...
//             <button onClick={showPrevious} className="bg-white p-2 rounded-full shadow hover:bg-indigo-100 hover:scale-110 transition">
//               <ChevronLeft size={24} />
//             </button>
//           </div>
//         )}
...
//             <button onClick={showNext} className="bg-white p-2 rounded-full shadow hover:bg-indigo-100 hover:scale-110 transition">
...
//         {/* Scrollable Cards */}
//         <div className="overflow-hidden bg-gray-200 pt-2 pb-2 rounded-md">
//           <div
...
//                   visibleCards === 1 ? '' : visibleCards === 2 ? 'sm:w-1/2' : 'lg:w-1/3'
//                 } px-2`}
//               >
//                 <div className="bg-white border rounded-md hover:bg-purple-50 shadow hover:shadow-2xl transition-all overflow-hidden">
...
//                     <div className="relative mt-3 max-h-[4.5em] overflow-hidden mt-5 mb-3">
//                       <p className="text-gray-600" dangerouslySetInnerHTML={{ __html: blog.description }}></p>
//                       <div className="absolute bottom-0 right-0 bg-gradient-to-l from-white pl-2">
//                         <ArrowRight
//                           className="w-4 h-4 text-indigo-600 cursor-pointer hover:translate-x-0.5 transition-transform duration-200"
//                           title="Read more"
//                         />
//                       </div>
//                     </div>
...
//             className="inline-flex items-center px-6 py-2 bg-indigo-600 text-white font-medium rounded-full hover:bg-indigo-700 transition-colors duration-300 shadow"
//           >
//             Read All Blogs
//           </button>
//         </div>
