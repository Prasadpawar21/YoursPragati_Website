...
//     try {
//       const res = await fetch("http://localhost:3000/api/admin-dashboard/field-work", {
//         method: "POST",
//         body: formData,
//       });
...
//         <h2 className="text-2xl font-bold text-blue-700 mb-4">Upload Field Image</h2>
...
//               <label className="inline-block px-4 py-2 text-white bg-blue-600 rounded cursor-pointer hover:bg-blue-700">
...
//     try {
//       const res = await fetch("http://localhost:3000/api/admin-dashboard/field-work/create", {
//         method: "POST",
//         body: formData,
//       });
...
//                 src={image.preview}
//                 alt="Preview"
//                 className="mx-auto h-60 object-contain rounded"
//               />
//             ) : (
//               <div className="flex flex-col items-center gap-2">
//                 <FiUploadCloud className="text-blue-500 text-4xl" />
...
//             onClick={handleUpload}
//             disabled={loading}
//             className={`w-full flex justify-center items-center gap-2 py-2 rounded-md text-white ${
//               loading
...
export default function DataCollectionAddImage() {
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-screen bg-gray-50 flex items-center justify-center px-4 py-8">
        <div className="bg-white p-6 rounded-sm shadow-xl w-full max-w-3xl pt-8 pb-8">
          <h2 className="text-2xl font-bold text-blue-700 mb-4">Upload Field Image</h2>
          ...
          <input
            type="text"
            placeholder="Enter caption for the image"
            className={`w-full px-4 py-2 border rounded-sm mb-1 focus:outline-none focus:ring-2 ${
