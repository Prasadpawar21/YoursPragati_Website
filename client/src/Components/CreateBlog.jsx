...
//     formData.append('tags', tags); // send raw string (will split in backend or you can convert here)
...
//           className="mt-2 p-2 w-full border rounded"
//           placeholder="e.g., react,frontend,ui (separate tags with commas)"
//         />
//       </label>
...
//         <h2 className="text-3xl font-semibold text-center text-indigo-700 mb-10">Create a New Blog Post</h2>
...
//             <p className="text-sm text-gray-600">Drag and Drop Image to upload</p>
...
//             value={title}
//             onChange={(e) => setTitle(e.target.value)}
//             className="mt-2 w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-400"
...
//         <label className="block mb-6">
//           <span className="text-gray-700 font-medium">Blog Content</span>
//           <div className="mt-2 border border-gray-300 rounded-lg overflow-hidden shadow-sm">
//             <JoditEditor
//               ref={editor}
//               value={description}
//               onChange={(newContent) => setDescription(newContent)}
...
//     formData.append('image', image.file);
//     formData.append('title', title);
//     formData.append('createdAt', createdAt.toISOString()); // ISO format
//     formData.append('description', description);
...
//             {image?.preview && (
//               <div className="mb-4">
//                 <img src={image.preview} alt="Preview" className="mx-auto h-66 object-contain rounded-sm" />
//               </div>
//             )}
...
//             onClick={handleSubmit}
//             disabled={isLoading}
//             className={`w-auto pl-6 pr-6 py-3 flex items-center justify-center bg-indigo-600 text-white font-medium rounded-sm hover:bg-indigo-700 transition duration-200 ${
//               isLoading ? 'opacity-70 cursor-not-allowed' : ''
//             }`}
//           >
//             {isLoading ? (
...
//   const [createdAt, setCreatedAt] = useState(new Date());
//   const [tags, setTags] = useState('');
//   const [description, setDescription] = useState(''); // Used for onBlur
//   const [isDragging, setIsDragging] = useState(false);
//   const [isLoading, setIsLoading] = useState(false);
...
//   const handleSubmit = async () => {
//     const latestDescription = editor.current?.value || description;

//     if (!image || !title || !latestDescription) {
//       alert('Please fill in all required fields.');
//       return;
//     }
...
//                   src={image.preview}
//                   alt="Preview"
//                   className="mx-auto h-66 object-contain rounded-sm"
//                 />
//               </div>
//             )}
//             <div className="flex flex-col items-center gap-2 mt-4 mb-4">
