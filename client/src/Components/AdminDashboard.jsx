...
//     {
//       title: "Work on Field",
//       count: 12, // Example count — replace dynamically if needed
//       color: "bg-teal-500",
...
//     <div>
//       <Navbar />
//       <div className="min-h-screen bg-gray-100 pt-[100px] px-4 pb-8">
//         {/* Admin Ticket */}
//         <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-2xl p-6 mb-8 shadow-xl flex flex-col sm:flex-row items-center sm:items-start gap-4 relative overflow-hidden">
//           {/* Profile Initials */}
//           <div className="flex-shrink-0 w-14 h-14 sm:w-16 sm:h-16 rounded-full bg-white text-purple-700 font-bold text-xl sm:text-2xl flex items-center justify-center shadow-md border border-white">
//             {getInitials(adminInfo.fullName)}
//           </div>

//           {/* Admin Details */}
//           <div className="z-10 flex-1">
//             <h1 className="text-xl sm:text-2xl font-bold mb-1">Welcome, {adminInfo.fullName}</h1>
//             <p className="text-sm sm:text-base">📧 <span className="font-medium">{adminInfo.email}</span></p>
//             <p className="text-sm sm:text-base">🔐 Role: <span className="font-semibold text-yellow-300">{adminInfo.role}</span></p>
//           </div>

//           {/* Decorative Circles */}
//           <div className="absolute top-0 left-0 h-full w-16 bg-white opacity-10 rounded-r-full"></div>
//           <div className="absolute top-0 right-0 h-full w-16 bg-white opacity-10 rounded-l-full"></div>
//         </div>
...
//             <div
//               key={index}
//               className={`${stat.color} rounded-xl shadow-lg p-4 cursor-pointer relative overflow-hidden transition-transform transform hover:scale-105`}
//               onClick={() => navigate(stat.path)}
//             >
//               <h2 className="text-white text-lg font-semibold mb-1">{stat.title}</h2>
//               <p className="text-white text-3xl font-bold">{stat.count}</p>
//               <span className="text-sm text-white mt-1 inline-block underline">More info</span>
//               {stat.icon}
//             </div>
//           ))}
//         </div>
...
//   FaUserShield,
//   FaGlobeAmericas,
//   FaUserFriends, // 👈 for team members icon
// } from "react-icons/fa";
// import Navbar from "./Navbar";
